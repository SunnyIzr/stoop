class ConversationsController < ApplicationController
  ...
  def show
    ...
    render :json => {user: current_user, conversation: conversation, receipts: receipts, messages: messages ,other_partcipant: (conversation.participants - [ current_user ]).first}
